...
public class zgcpMr {
    ...
    public static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values,
                ...
                context.write(key, new Text("sczq"));
...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/database/result/zgcp");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/yewuzhanghu11"));
