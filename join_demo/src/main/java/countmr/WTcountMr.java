        ...
        protected void reduce(Text key, Iterable<Text> values,
            ...
            if(values.iterator().hasNext()) {
                for (Text val : values) {
                    ...
                    {
                        //String result=String.valueOf(sum);
                        context.write(key, new Text("非常不活跃"));
                    }
                }
            }
...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/mr/ordertime");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/huoyuedu8"));
