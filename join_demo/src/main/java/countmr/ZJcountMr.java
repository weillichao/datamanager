    ...
    public static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values,
            ...
            for (Text val : values) {
                ...
                sum=sum+abs(Double.valueOf(valuess[1]));
                sum=sum+abs(Double.valueOf(valuess[2]));
            }
            //如果上面部门编号是1，则这里也是1。
...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/mr/TZJLS");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/zjcount"));
