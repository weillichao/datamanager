    ...
    public static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values,
            ...
            for (Text val : values) {
                ...
                mark=valuess[1]+" "+valuess[2]+" "+valuess[3];
                result=result+mark+"\t";
            }
...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/database/TZJZH");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/gpresult1"));
