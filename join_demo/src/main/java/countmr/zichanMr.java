...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/label/aboss/ZQGL/");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/zichan"));
