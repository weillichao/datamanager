...
public class sdxLabel {
    ...
    public static class MyReducer extends Reducer<Text, Text, Text, Text> {
        ...
        labelUtil util=new labelUtil();

        public MyReducer() throws IOException {
        }
           ...
           // labelUtil util=new labelUtil();
            if(values.iterator().hasNext()) {
                for (Text val : values) {
                    ...
                    //String result="";
                    context.write(key, new Text(util.getCPDJResult(valuess[1])));
                    }
...
//        conf.set("yarn.resourcemanager.scheduler.address", "hadoop1:8030");
        ...
        //要处理的数据输入与输出地址
        FileInputFormat.setInputPaths(job, "hdfs://n1:8020/user/label/cif/sdx/");
        FileOutputFormat.setOutputPath(job, new Path("hdfs://n1:8020/user/mr/sdx2"));
